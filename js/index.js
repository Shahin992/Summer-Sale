...
function cardclicked (target){
   ...
   const applyBtn =  document.getElementById('discount-btn')
    ...
    const getSubTotalString = getSubTotal.innerText;
    getSubTotal.innerText = finalGrandTotal.toFixed(2);
...
function ConvertToFloat (id){
    const getElement = document.getElementById('id');
         ...
         const convertFloat = parseFloat(getString);
         return convertFloat;
}
